 ...
 *
 * The entity is attached to `req.storage.storedFile` by the {@link UploadInterceptor}
...
export const StoredFile = createParamDecorator(
  /**
   * Returns the stored file entity at `req.storage.storedFile`.
   *
   * @param _data - Ignored.
