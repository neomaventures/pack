...
const errorTemplate = readFileSync(join(viewsDir, "error.ejs"), "utf-8")
const badRequestTemplate = readFileSync(
  join(viewsDir, "bad-request.ejs"),
  "utf-8",
)
const serverErrorTemplate = readFileSync(
  join(viewsDir, "server-error.ejs"),
  "utf-8",
)
const withLocalsTemplate = readFileSync(
  join(viewsDir, "with-locals.ejs"),
  "utf-8",
)
...
describe("Content Negotiation", () => {
  ...
  beforeEach(async () => {
    app = await managedAppInstance({
      module: "e2e/app/content-negotiation.module.ts#ContentNegotiationModule",
