...
Adds `AUTH_TEST_OPTIONS` — a minimal valid `AuthOptions` constant exported for use in consumer unit tests that need to compile a Nest testing module which imports `AuthModule.forRoot(...)`.
